...
**Status**: MVP Phase 1 Complete + Navigation Implementation Complete
...
- **Embedded Edit Buttons**: Edit buttons integrated within each card header (not floating)
- **Note Detail Pages**: Full-screen note viewing with `/note/[id]` routes
- **View/Edit Mode Toggle**: Radix UI Switch for seamless view ↔ edit mode switching
- **Markdown Editor**: Raw markdown editing with live preview on mode switch
- **Auto-Save**: Automatic saving to localStorage after 2-second delay
- **Save Status Indicator**: Real-time "Saving..." / "Saved" feedback in header
- **Title Extraction**: Dynamic title from first H1 header or first line of content

#### **Touch-Friendly Interactions**
- **40px Edit Buttons**: Embedded edit buttons with optimal touch targets
- **Card Navigation**: Tap edit button to navigate to note detail pages
- **Back Navigation**: Clear back button in note detail header
...
- **Modern Tooling**: Next.js 15, Vitest, React Testing Library, Radix UI
...
│   │   ├── page.tsx       # Note detail component
...
```json
{
  ...
  "@radix-ui/react-switch": "1.2.5",     // UI components
