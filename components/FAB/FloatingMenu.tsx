        ...
        <Portal.Root>
            ...
            >
                ...
                <div className="pointer-events-auto flex flex-col gap-3">
                    ...
                    {/* Flip All to Front Button - only show in main view when not in note view */}
                    {!isInNoteView && onFlipAllToFront && (
                        <div className="flex items-center gap-3">
                            {/* Text label - positioned to the left */}
                            <button
                                onClick={onFlipAllToFront}
                                className={`bg-purple-600/90 text-white px-3 py-1 rounded-lg text-sm font-medium transition-all duration-500 delay-75 hover:bg-purple-700/90 ${showLabels ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-2'
                                    }`}
                            >
                                Flip All Front
                            </button>
